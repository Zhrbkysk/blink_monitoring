...
eye_cascade = cv2.CascadeClassifier('static/cascade/haarcascade_eye_tree_eyeglasses.xml')


def get_unique_eyes(eyes):
    unique_eyes = []
...
def get_eyes_state(img):
    ...
    if faces:
        ...
        unique_eyes = get_unique_eyes(eyes)
